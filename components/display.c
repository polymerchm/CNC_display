...
lcd_user_data_t init_lcd_display(void)
{
    ...
    ESP_ERROR_CHECK(esp_lcd_new_panel_ili9341(lcd_io, &panel_config, &lcd_panel_handle));
    ...
    lcd_user_data.io = lcd_io;
    lcd_user_data.panel = lcd_panel_handle;

    return lcd_user_data;
}